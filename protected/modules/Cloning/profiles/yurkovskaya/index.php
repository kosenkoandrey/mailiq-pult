...
exec('cp -f ' . $src . '/custom/protected/modules/Costs/adsapi_php.ini ' . $dist . '/protected/modules/Costs/adsapi_php.ini');
...
exec('cp -f ' . $src . '/custom/protected/modules/SendThis/daemon/config.json ' . $dist . '/protected/modules/SendThis/daemon/config.json');
